...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-linear-to-br from-orange-500 via-orange-600 to-teal-600 text-white overflow-hidden">
